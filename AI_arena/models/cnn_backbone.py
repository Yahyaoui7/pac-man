...
class PacmanCNNBackbone(nn.Module):
    """Shared spatial CNN encoder (12 channels -> 128 channels) and dense feature trunk (256 -> 128)."""
    ...
    def extract_features(self, grid: Tensor, extra_features: Tensor) -> Tensor:
        """Extract 128-dimensional latent representation combining spatial grid and state features."""
