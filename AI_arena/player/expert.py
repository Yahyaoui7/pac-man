...
class PacmanExpert:
    ...
    def choose_action(self, env: Any) -> ExpertDecision:
        if env.movement is None or env.player is None or env.pellets is None:
        ...
        for ghost in env.ghosts:
            ...
            (edible_maps if ghost.is_edible else dangerous_maps).append(distances)
        ...
        return ExpertDecision(action=action, scores=tuple(scores))
