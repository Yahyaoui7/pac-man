...
class GameOverState(State):
    ...
    def __init__(self, game: Any, previous_state: State) -> None:
        ...
        self.name_button = Button((0, 0), "Enter Your Name", ui.FONT_BTN)
        self.hi_score_button = Button((0, 0), "Highest Score", ui.FONT_BTN)
        self.home_button = Button((0, 0), "Home Menu", ui.FONT_BTN)
        self.buttons = [
            self.name_button,
            self.hi_score_button,
            self.home_button,
        ]
    ...
    def enter(self) -> None:
        ...
        self.name_button.rect.topleft = (center_x - 100, center_y + 20)
        self.hi_score_button.rect.topleft = (center_x - 100, center_y + 85)
        self.home_button.rect.topleft = (center_x - 100, center_y + 150)
    ...
    def draw(self, screen: pygame.Surface) -> None:
        ...
        # Reposition buttons dynamically to match current screen center
        self.name_button.rect.topleft = (center_x - 100, center_y + 20)
        self.hi_score_button.rect.topleft = (center_x - 100, center_y + 85)
        self.home_button.rect.topleft = (center_x - 100, center_y + 150)
