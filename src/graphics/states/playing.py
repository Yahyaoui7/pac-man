...
class PlayingState(State):
    ...
    def __init__(self, game: Any) -> None:
        ...
        self.ai_initial_pellet_count: int | None = None
    ...
    def enter(self) -> None:
        ...
        try:
            ...
            self.ai_initial_pellet_count = (
                self.game.entity_manager.total_pellets
            )
        except (FileNotFoundError, RuntimeError, ValueError) as exc:
            print(f"Player SL model unavailable: {exc}")
        ...
        if self.use_ai_player and self.player_controller is not None:
            ...
            if (
                ...
                action = self.player_controller.get_action(
                    ...
                    em.ghosts,
                    self.movement,
                    initial_pellet_count=self.ai_initial_pellet_count,
                    sample=False,
                )
                if action:
